...
setup(
    ...
    description="Caching Infrastructure for Tendril",
    long_description='\n'.join([read('README.rst'), read('CHANGELOG.rst')]),
    long_description_content_type='text/x-rst',
    keywords='tendril',
    url='https://github.com/tendril-framework/tendril-caching',
    project_urls={
        'Documentation': 'https://tendril-caching.readthedocs.io/en/latest',
        'Bug Tracker': 'https://github.com/tendril-framework/tendril-caching/issues',
        'Source Repository': 'https://github.com/tendril-framework/tendril-caching',
    },
